...
@Component({
  selector: 'app-facturer-e-commerce',
  templateUrl: './facturer-e-commerce.component.html',
  styleUrls: ['./facturer-e-commerce.component.scss']
})
export class FacturerECommerceComponent implements OnInit {
    ...
    getColisClassicLivrerOfClients() {
      ...
      this.facturerService
        .getShipmentEcommerceWithIntervalOfClient(
    ...
    facturerDetail() {
      this.facturerService
        .facturerShipmentOfClientEcommerceDetail(
          this.dateForm.get('clientSelected').value,
          this.dateForm.get('dateDebut').value,
          this.dateForm.get('dateFin').value,
          this.dateForm.get('espece').value
    ...
    facturerSimple() {
      this.facturerService
        .facturerShipmentOfClientEcommerceSimple(
          this.dateForm.get('clientSelected').value,
          this.dateForm.get('dateDebut').value,
          this.dateForm.get('dateFin').value,
          this.dateForm.get('espece').value
